 ...
 */
class INET_API StateBasedEnergyConsumer_SimuLTE : public cSimpleModule, public IEnergyConsumer_SimuLTE, public cListener
{
  protected:
    // parameters
  ...
  public:
    StateBasedEnergyConsumer_SimuLTE();
