...
#ifndef __INET_IENERGYCONSUMER_SimuLTE_H
#define __INET_IENERGYCONSUMER_SimuLTE_H
 ...
 */
class INET_API IEnergyConsumer_SimuLTE // ver se precisa alterar a classe //JINSERT
{
  public:
    virtual ~IEnergyConsumer_SimuLTE() {}

    /**
     * Returns the current power consumption in the range [0, +infinity).
     */
    virtual inet::power::W getPowerConsumption() const = 0;
};
